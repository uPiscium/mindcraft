...
- 現在 Python 側に持っているコマンドは `!stats`, `!inventory`, `!nearbyBlocks`, `!entities`, `!stop`, `!goal`, `!newAction`
- 追加候補: `!help`, `!craftable` など未移行の query 系
...
- `!inventory`, `!nearbyBlocks`, `!entities` の返答バリエーションを増やす
