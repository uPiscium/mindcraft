...
- `src/agent/self_prompter.js` で current task を prompt に注入している．
...
- 回帰テストは `tests/test_runtime_task_pool_integration.py` と `tests/test_runtime_task_file_loader.py` にある．
